 ...
 */
public class boxUps10 extends BasePackage {
    public boxUps10(String id, int weight, PackageType Type, Address receiverAddress, Address senderAddress, FullName senderFullName, FullName receiverFullName) {
