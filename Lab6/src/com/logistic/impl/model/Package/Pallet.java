 ...
 */
public class Pallet extends BasePackage {
    public Pallet(String id, int weight, PackageType Type, Address receiverAddress, Address senderAddress, FullName senderFullName, FullName receiverFullName) {
