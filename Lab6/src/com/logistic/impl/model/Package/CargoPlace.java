 ...
 */
public class CargoPlace extends BasePackage {
    public CargoPlace(String id, int weight, PackageType Type, Address receiverAddress, Address senderAddress, FullName senderFullName, FullName receiverFullName) {
